...
As we will see, even a design choice as complicated and pervasive as a multi-level cache coherence protocol can be madeinto a tuneable design parameter when properly factored out from the rest of the design.
...
RISC-V-based platform~\cite{asanovic-riscv-mpreport2014}.
The generator consists of a collection of
