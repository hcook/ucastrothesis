...
Typically the data block size is set based on the desired ratio of metadata to data storage overhead,
...
\item When running on networks that provide guaranteed ordering of messages between any client/manager pair, the Finish acknowledgment of a Grant (and the Grant acknowledgement of a voluntary Release) may be omitted.
\end{itemize}
