...
Associate with TL parameters.
Tied to coherence metadata objects: in agents with multiple types of objects, accessing the methods
automatically parameterizes the width of the bundles correctly!
Dir -> CP -> TL -> Metadata.
Especially useful for inner vs outer.

Currently only parameter provided to Policy is directory format, but more could be introduced
...
as well as a TileLink-compatible NoC,
...
Integration with Parameters: associate TileLink parameters with coherence metadata objects
Dir -> CP -> TL -> 
...
Appendix~\ref{} provides an overview of related work in this area.
